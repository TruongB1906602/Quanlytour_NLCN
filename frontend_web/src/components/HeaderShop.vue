                        ...
                        >
                           ...
                           <div class="right">
                            ...
                            <div class="item-price">
                                <span class="text-light price-product"><span style="font-size:14px;">Giá: </span>{{  Intl.NumberFormat('de-DE',{style: 'currency',currency: 'VND'}).format(item.price) }}/người</span>
                            </div>
                            <div class="item-quantity">
                                <span class="text-light quantity-product"><span  style="font-size:14px">SL: </span>{{item.quantity}}</span>
                            </div>
                           </div>
                        </div>   
             ...
             <div class="login">
              ...
              <div class="collapse user_link" id="user">
                <div class="card card-body bg-white connect-shop">
                  <router-link to="/profile" class="text-white3"><img src="@/assets/images/user.png" alt="">
                    <span  style="margin-left:5px" class="text-light data_user" data-bs-toggle="collapse" href="#user"></span>
                  </router-link>
                   <a to="/" class="text-white4" @click="handlelogout()"><ion-icon name="log-out-outline"></ion-icon></a>
